    ...
    /******/
    {
      ...
      3:
        ...
        function (module, __webpack_exports__, __webpack_require__) {
          ...
          __webpack_require__.d(__webpack_exports__, 'QueryManager', () => {
            return (
              /* reexport */
              ...
              LogHelper.prototype.getMsg_ = function () {
                ...
                switch (this.type) {
                  ...
                  case ERROR_TYPE.NullValue:
                    errMsg =
                      "Null value is not allowed for column '" + this.info_['ColumnName'] + "'"
                    break
          ...
          var base_Base =
            ...
            (function () {
              ...
              Base.prototype.getColumnInfo = function (columnName, tableName) {
                return this.table(tableName).columns.find(column => {
          ...
          var query_helper_QueryHelper =
            ...
            (function () {
              ...
              QueryHelper.prototype.checkUpdate = function (query) {
                var err = new schema_checker_SchemaChecker(this.getTable_(query.in)).check(
                  query.set,
                  query.in
                )
                if (err) return err
                    ...
                    if (containsNot(whereQuery, queryKeys)) {
                      if (queryKeys.length === 1) {
                        ...
                        queryKeys.forEach(prop => {
                          ...
                          whereTmpQry_1.push(
                            addToSingleQry(((_a = {}), (_a[prop] = whereQuery[prop]), _a), [prop])
                          )
                        })
          ...
          var IS_WORKER =
            typeof self.alert === 'undefined' && typeof ServiceWorkerGlobalScope === 'undefined'
          ...
          var executeWhereUndefinedLogic = function () {
            ...
            if (this.query.order && this.query.order.idbSorting !== false && this.query.order.by) {
              if (this.objectStore.indexNames.contains(this.query.order.by)) {
                var orderType =
                  this.query.order.type && this.query.order.type.toLowerCase() === 'desc'
                    ? 'prev'
                    : 'next'
                this.sorted = true
          ...
          var where_checker_WhereChecker =
            ...
            (function () {
              ...
              WhereChecker.prototype.remove = function (props) {
                var last = props.pop()
                var value = props.reduce((prev, curr) => {
              ...
              WhereChecker.prototype.checkIn = function (column, value) {
                return (
                  this.where[column][QUERY_OPTION.In].find(q => {
              ...
              WhereChecker.prototype.checkComparisionOp_ = function (column, value, symbol) {
                ...
                return (
                  compare(value, compareValue.low, '>=') && compare(value, compareValue.high, '<=')
                )
              }
            ...
            (function () {
              ...
              Join.prototype.execute = function () {
                ...
                return this.executeSelect({
                  ...
                  _this.results = results.map(item => {
                    var _a
                ...
                if (this.results.length > 0) {
                  try {
                    ...
                    try {
                      ...
                      return promiseReject(
                        new log_helper_LogHelper(ERROR_TYPE.InvalidOrderQuery, ex.message)
                      )
                    }
                    ...
                    try {
                      ...
                      return promiseReject(
                        new log_helper_LogHelper(ERROR_TYPE.InvalidGroupQuery, ex.message)
                      )
                    }
                  } catch (ex) {
                    return promiseReject(
                      new log_helper_LogHelper(ERROR_TYPE.InvalidJoinQuery, ex.message)
                    )
              ...
              Join.prototype.jointables = function (joinType, jointblInfo, secondtableData) {
                ...
                var performInnerJoin = function () {
                  ...
                  _this.results.forEach(valueFromFirstTable => {
                    secondtableData.forEach(valueFromSecondTable => {
                      if (
                        valueFromFirstTable[table1Index][column1] === valueFromSecondTable[column2]
                      ) {
                ...
                var performleftJoin = function () {
                  ...
                  _this.getTable(jointblInfo.table2.table).columns.forEach(col => {
                  ...
                  _this.results.forEach(valueFromFirstTable => {
                    ...
                    valueMatchedFromSecondTable.forEach(value => {
                      results[index] = __assign({}, valueFromFirstTable)
              ...
              Join.prototype.checkJoinQuery_ = function (jointblInfo, qry) {
                ...
                if (
                  tableSchemaOf1stTable.columns.find(q => {
                  ...
                  tableSchemaOf2ndTable.columns.find(q => {
                ...
                tableSchemaOf1stTable.columns.every(column => {
                  var columnFound = tableSchemaOf2ndTable.columns.find(q => {
              ...
              function Select(query, util) {
                ...
                _this.returnResult_ = function () {
                  if (_this.query.flatten) {
                    ...
                    _this.query.flatten.forEach(column => {
                      _this.results.forEach((data, i) => {
                    ...
                    getKeys(indexToDelete_1).forEach(key => {
            ...
            (function (_super) {
              ...
              Update.prototype.executeComplexLogic_ = function () {
                ...
                return selectObject.execute(this.db).then(results => {
                  ...
                  results = null
                  var whereQry =
                    ((_a = {}), (_a[key] = ((_b = {}), (_b[QUERY_OPTION.In] = inQuery), _b)), _a)
              ...
              Intersect.prototype.execute = function (db) {
                ...
                var fetchData = function () {
                  if (index < queryLength) {
                    ...
                    return select.execute(_this.db).then(selectResult => {
                      hashMap = {}
            ...
            (function (_super) {
              ...
              Remove.prototype.processWhereArrayQry = function () {
                ...
                return selectObject.execute(this.db).then(results => {
                  ...
                  results = null
                  var whereQry =
                    ((_a = {}), (_a[pkey] = ((_b = {}), (_b[QUERY_OPTION.In] = keyList), _b)), _a)
          ...
          var transaction_Transaction =
            ...
            (function (_super) {
              ...
              Transaction.prototype.pushReq_ = function (request) {
                ...
                var promiseObj = promise((resolve, reject) => {
              ...
              QueryManager.prototype.run = function (request) {
                ...
                switch (request.name) {
                  ...
                  case API.Transaction:
                    queryResult = new transaction_Transaction(request.query, this.util).execute(
                      this.db
                    )
                    break
                ...
                return promise((res, rej) => {
                  _this.util
                    ...
                    .then(result => {
                      if (result) {
                        meta_helper_MetaHelper
                          .set(meta_helper_MetaHelper.dbSchema, dbMeta, _this.util)
                          .then(() => {
                            _this.db = dbMeta
                            res(true)
                          })
